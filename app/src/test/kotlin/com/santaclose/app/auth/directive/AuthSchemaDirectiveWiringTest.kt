...
//
//            // when
//            val exception = shouldThrow<GraphQLException> { authSchemaDirectiveWiring.onField(envMock) }
//
//            // then
...
//            shouldThrow<GraphqlErrorException> { slot.captured.get(fetchEnvMock) }.apply {
